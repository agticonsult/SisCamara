...
class PessoaUserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('pessoas')->insert([
            ['pessoaJuridica' => 0, 'nome' => 'Agile', 'apelidoFantasia' => NULL, 'dt_nascimento_fundacao' => '2001-01-01', 'cadastradoPorUsuario' => $uuid1, 'created_at' => Carbon::now(), 'ativo' => Pessoa::ATIVO],
            ['pessoaJuridica' => 0, 'nome' => 'Fulano', 'apelidoFantasia' => NULL, 'dt_nascimento_fundacao' => '2001-02-01', 'cadastradoPorUsuario' => $uuid1, 'created_at' => Carbon::now(), 'ativo' => Pessoa::ATIVO],
            ['pessoaJuridica' => 0, 'nome' => 'Ciclano', 'apelidoFantasia' => NULL, 'dt_nascimento_fundacao' => '2001-03-01', 'cadastradoPorUsuario' => $uuid1, 'created_at' => Carbon::now(), 'ativo' => Pessoa::ATIVO],
            ['pessoaJuridica' => 0, 'nome' => 'Beltrano', 'apelidoFantasia' => NULL, 'dt_nascimento_fundacao' => '2001-04-01',  'cadastradoPorUsuario' => $uuid1, 'created_at' => Carbon::now(), 'ativo' => Pessoa::ATIVO]
        ]);

        DB::table('users')->insert([
            [
                'id' => $uuid1, 'id_pessoa' => 1, 'cpf' => '00000000000', 'email' => 'suporte@agile.inf.br', 'password' => Hash::make('sup2011@'),
                'tentativa_senha' => 0, 'bloqueadoPorTentativa' => 0, 'ativo' => User::ATIVO,
