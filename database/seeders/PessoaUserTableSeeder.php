...
class PessoaUserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('permissaos')->insert([
            ...
            ['id_user' => $uuid3, 'id_perfil' => 2, 'ativo' => 1, 'cadastradoPorUsuario' => $uuid1, 'created_at' => '2022-09-22 16:56:00'],
            ['id_user' => $uuid4, 'id_perfil' => 2, 'ativo' => 1, 'cadastradoPorUsuario' => $uuid1, 'created_at' => '2022-09-22 16:56:00']
        ]);
    }
}
