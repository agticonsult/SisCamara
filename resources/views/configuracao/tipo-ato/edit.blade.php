...
<div class="card" style="background-color:white">
    ...
    <div class="card-header">
        <h2 class="text-center">
            ...
            <strong>Alteração do Tipo de Ato</strong>
        </h2>
    </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" name="descricao" id="descricao" value="{{ $tipoAto->descricao != null ? $tipoAto->descricao : old('descricao') }}">
                        </div>
                        <div class="col-md-12">
