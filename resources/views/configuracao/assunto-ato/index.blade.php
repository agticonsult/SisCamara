        ...
        <div id="accordion3">
            <div class="card">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion3">
                    <div class="card-body">
                        <form action="{{ route('configuracao.assunto_ato.store') }}" id="form" method="POST"
                                ...
                                <tbody>
                                    @foreach ($assuntoAtos as $assunto)
                                        <tr>
                                            ...
                                            <td>
                                                <strong>{{ $assunto->cadastradoPorUsuario != null ? $assunto->cad_usuario->pessoa->nomeCompleto : 'cadastrado pelo sistema' }}</strong>
                                                em
                                            ...
                                            <td>
                                                <a href="{{ route('configuracao.assunto_ato.edit', $assunto->id) }}"
                                                    class="btn btn-warning"><i
                                                        class="align-middle me-2 fas fa-fw fa-pen"></i></a>
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                                    data-target="#exampleModalExcluir{{ $assunto->id }}"><i
                                                        ...
                                                        <div class="modal-header btn-danger">
                                                            <h5 class="modal-title text-center" id="exampleModalLabelExcluir">
                                                                <strong style="font-size: 1.2rem">Excluir
                                                                    <i>{{ $assunto->descricao != null ? $assunto->descricao : 'não informado' }}</i></strong>
                                                            </h5>
                                                        </div>
