                ...
                <table id="datatables-reponsive" class="table table-bordered" style="width: 100%;">
                    ...
                    <tbody>
                        @foreach ($vereador_votacaos as $vereador_votacao)
                            <tr>
                                <td>{{ $vereador_votacao->votacao->data != null ? date('d/m/Y', strtotime($vereador_votacao->votacao->data)) : 'não informado' }}</td>
                                <td>{{ $vereador_votacao->votacao->id_tipo_votacao != null ? $vereador_votacao->votacao->tipo_votacao->descricao : 'não informado' }}</td>
                                <td>{{ $vereador_votacao->votacao->id_proposicao != null ? $vereador_votacao->votacao->proposicao->titulo : 'não informado' }}</td>
                                <td>Início: <strong>{{ $vereador_votacao->votacao->legislatura->inicio_mandato }}</strong> - Fim: <strong>{{ $vereador_votacao->votacao->legislatura->fim_mandato }}</strong></td>
                                {{-- <td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('votacao_eletronica.vereador.votacao', $vereador_votacao->id) }}" class="btn btn-warning m-1">Votar</a>
                                    @else
