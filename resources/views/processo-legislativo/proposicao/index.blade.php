...
<h1 class="h3 mb-3"><span class="caminho">Processo Legislativo > </span>Proposições</h1>
                                    ...
                                    <form method="POST" class="form_prevent_multiple_submits" action="{{ route('proposicao.destroy', $proposicao->id) }}">
                                        ...
                                        <div class="modal-header btn-danger">
                                            <h5 class="modal-title text-center" id="exampleModalLabelExcluir">
                                                Excluir Proposição - <strong>{{ $proposicao->titulo != null ? $proposicao->titulo : 'não informado' }}</strong>
                                            </h5>
                                        </div>
